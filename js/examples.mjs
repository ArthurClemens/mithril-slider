...
var Touch = function Touch(_ref) {
  ...
  var hammer$$1 = new hammer.Manager(el, {});
  ...
  hammer$$1.on("panstart", onStart);
  hammer$$1.on("panmove", onMove);
  hammer$$1.on("panend", onEnd);

  return {
    destroy: function destroy() {
      hammer$$1.off("panstart", onStart);
      hammer$$1.off("panmove", onMove);
      hammer$$1.off("panend", onEnd);
    }
  };
};
