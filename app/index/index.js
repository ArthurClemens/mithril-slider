"bundle";
System.registerDynamic("app/index/index", ["lib/mithril/mithril.min", "app/images/images", "app/vertical/vertical", "app/controls/controls", "app/group/group", "app/pages/pages", "app/index/index.css!lib/system-css/css"], true, function(require, exports, module) {
  ;
  var global = this,
  ...
  var app = {};
  app.view = function() {
    return (0, _mithril2["default"])("div", [(0, _mithril2["default"])("h1", "Content slider for Mithril"), menu]);
  };
...
System.registerDynamic("lib/mithril-slider/mithril-slider", ["lib/mithril/mithril.min", "lib/hammerjs/hammer.min", "lib/mithril-slider/mithril-slider.css!lib/system-css/css"], true, function(require, exports, module) {
  ...
  slider.controller = function() {
    ...
    var pageSelector = opts.pageSelector || ".page";
    ...
    var getPageEl = function getPageEl(el, idx) {
      return el.querySelectorAll(pageSelector)[idx];
    };
    ...
    var updateContentSize = function updateContentSize(el) {
      var page = el.querySelector(pageSelector);
